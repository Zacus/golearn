...
func GetPostList2() (data []*models.ApiPostDetail, err error) {
	postList, err := mysql.GetPostList2()
	if err != nil {
		fmt.Println(err)
		return
	}
...
func GetPostList(pageStart, pageLimit int64) (data []*models.ApiPostDetail, err error) {

	postList, err := mysql.GetPostList(pageStart, pageLimit)
	if err != nil {
		fmt.Println(err)
		return
	}
